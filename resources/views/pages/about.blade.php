                            ...
                            <div class="long-term-container">
                                ...
                                <div class="container-bottom">
                                    @foreach($v as $translation)
                                        ...
                                        <div @if($loop->last && $loop->parent->last) class="container-box last-box"
                                             @else class="container-box" @endif>
                                            <div class="box-title">
                                                <span
                                                    class="card-month">{{\App\Helpers\LanguageHelper::DateTranslate($translation->date)}}</span>
                                            </div>
                                            <div class="box-tmain">
                ...
                <div class="col-lg-6 col-12">
                    <div class="future-left">
                        ...
                        <a href="{{route('industries')}}"
                           class="fututre_link future_btn">{{trans('front.our_industries')}}</a>
                    </div>
                </div>
                <div class="col-lg-6 col-12">
                            ...
                            @foreach($futureItem->localized_data as $fi)
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="future_developing">
                                        <img class="img-fluid" src="{{$futureItem->image}}" width="80" height="80">
                    ...
                    <div class="col-lg-4 col-12">
                        @foreach($futureItem->localized_data as $fi)
                            <div class="future_bottom_card">
                                <span class="future_01">0{{$loop->parent->iteration}}</span>
