            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-8">
                            <h2 class="content-header-title float-left mb-0">{{trans('show')}}</h2>
                        </div>
                    </div>
                </div>
                                        ...
                                        @endforeach
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <img name="old_image" src="{{$unlock->background_image}}" class="img-fluid"
                                                         style="width: 150px" alt="{{$unlock->background_image}}">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <img name="old_image" src="{{$unlock->image}}" class="img-fluid"
                                                         style="width: 150px" alt="{{$unlock->image}}">
                                                </div>
                                            </div>
