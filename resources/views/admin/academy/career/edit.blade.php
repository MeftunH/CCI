    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin strecth  stretch-card">
                ...
                <form action="{{route('aboutUs.academyCareer.update',$academy_career->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        @foreach($translations as $translation)
                                            <div
                                                ...
                                                <div class="form-group">
                                                    <textarea class="summernote_description[{{ $translation->language_id}}]"
                                                              name="description[{{ $translation->language_id}}]"
                                                              value="{{ $translation->description }}" rows="30"
                                                              id="summernote{{ $translation->language_id}}">{{$translation->description}}</textarea>
                                                </div>
                                                <br>
