    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{trans('back.edit_innovation_item')}}</h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 grid-margin strecth  stretch-card">
                ...
                <form action="{{route('aboutUs.services.innovation.item.update',$innovation_item->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <div class="col-md-6 col-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    ...
                                                    <img src="{{$innovation_item->image}}"  alt="{{$innovation_item->image}}" class="img-fluid" >
                                                    <input type="hidden" name="old_image" value="{{ $innovation_item->image }}">
                                                </div>
                                            </div>
                                        </div>
                                        <label>
                                            <select class="form-control" name="status">
                                                ...
                                                <option @if ($innovation_item->status ==1) selected @endif value="1">
                                                    Active
                                                </option>
                                                <option @if ($innovation_item->status ==0)selected @endif  value="0">
                                                    Passive
                                                </option>
                                            </select>
                                        </label>
