    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{trans('long_time_line_item_create')}}</h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 grid-margin strecth  stretch-card">
                ...
                <form action="{{route('aboutUs.long_term.timeline.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <input type="date" id="fp-default" class="form-control format-picker"
                                               name="date"/>
