    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin strecth  stretch-card">
                ...
                <form action="{{route('aboutUs.long_term.timeline.update',$time_line->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        @endforeach
                                            ...
                                            <input type="date" id="fp-default" value="{{$translation->date}}" class="form-control format-picker"
                                                   name="date"/>
                                    </div>
                                    <br>
                                    <div class="row">
