    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-8">
                            <h2 class="content-header-title float-left mb-0">   {{trans('back.show_future')}}</h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 grid-margin strecth  stretch-card">
                ...
                @endif
                <form action="{{route('aboutUs.future.update',$future->id)}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        @foreach($future->first()->translations as $translation)
                                            <div
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="summernote"
                                                              ...
                                                              value="{{ $translation->description }}" rows="15"
