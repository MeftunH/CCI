...
Route::group(['prefix' => LaravelLocalization::setLocale(),
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::name('homepage.')->group(function () {
            Route::get('innovationModule/edit/{id}', [HomeController::class, 'innovationModuleEdit'])->name('innovationModuleEdit');
            Route::get('innovationModule/show/{id}', [HomeController::class, 'innovationModuleShow'])->name('innovationModuleShow');
            Route::post('innovationModule/edit/{id}', [HomeController::class, 'innovationModuleUpdate'])->name('innovationModuleUpdate');
        ...
        Route::get('/mails/{id}/editMailAddress', [MailController::class, 'edit'])->name('mails.edit');
        Route::post('/mails/{id}/editMailAddress', [MailController::class, 'update'])->name('mails.update');
    ...
    Route::get('/', [FrontHomePageController::class, 'index'])->name('index');
