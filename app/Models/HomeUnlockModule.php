...
class HomeUnlockModule extends Model
{
    use HasFactory;
    protected $guarded=[];
    public function translations()
    {
        return $this->hasMany(HomeUnlockModuleTranslation::class);
    }
    public function scopeLanguages($query,$currentLang)
    {
        return $query
            ->join('home_unlock_module_translations','intro_id','home_unlock_modules.id')
